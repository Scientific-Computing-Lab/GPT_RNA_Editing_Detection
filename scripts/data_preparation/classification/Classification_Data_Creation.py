...
if __name__ == '__main__':
    ...
    parser.add_argument('--editing_site_plus', '--editing_site_plus', dest="editing_site_plus", help='A file that contains data on the levels of editing in adenosines in the positive strand (chr,start,end, coverage, editing level)', type=str,required=True)
    parser.add_argument('--editing_site_minus', '--editing_site_minus', dest="editing_site_minus", help='A file that contains data on the levels of editing in adenosines in the negative strand (chr,start,end, coverage, editing level)', type=str,required=True)
